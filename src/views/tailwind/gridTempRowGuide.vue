<template>
  <div class="page-title-wrap gap-4 justify-between">
    <h2 class="c-h1">grid-template-rows</h2>
  ...
  <div class="cont-zone-wrap">
    ...
    <div class="conts-area">
      <h3 class="c-h3">서브그리드</h3>
      <p class="c-information-text mt-5">'grid-rows-subgrid'를 사용하여 부모가 정의한 행을 자식 요소에도 적용할 수 있습니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">중단점으로 원하는 화면 크기에서 아이템의 그리드 행을 설정합니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
