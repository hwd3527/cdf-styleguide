<template>
  <div class="page-title-wrap gap-4 justify-between">
    <h2 class="c-h1">justify-self</h2>
    <a class="c-btn size-xs outline" href="https://tailwindcss.com/docs/justify-self" target="_blank">
      <span class="txt">tailwind에서 더보기</span>
    </a>
  </div>
  <div class="cont-zone-wrap">
    <div class="conts-area">
      <h3 class="c-h3">Auto</h3>
      <p class="c-information-text mt-5">'justify-self-auto'는 부모 'justify-items' 속성 값에 따라 정렬합니다.</p>
      <div class="tabs">
        ...
        <div class="tab-conts">
          <div role="tabpanel" aria-labelledby="tabList0101" id="tabPanel0101" class="tab-panel on">
            <div class="container normal">
              <div class="grid grid-cols-3 justify-items-stretch gap-2 p-3 bg-gray-200 w-full md:w-3xl">
                <div class="box-border">Item 1</div>
                <div class="box-border justify-self-auto !bg-cyan-300">Item 2</div>
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">'justify-self-start'는 그리드 항목의 인라인 축의 시작 부분에 정렬합니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
        ...
        <div class="tab-conts">
          <div role="tabpanel" aria-labelledby="tabList0101" id="tabPanel0101" class="tab-panel on">
            <div class="container normal">
              <div class="grid justify-items-stretch grid-cols-3 gap-2 p-3 bg-gray-200 w-full md:w-3xl">
                <div class="box-border">Item 1</div>
                <div class="box-border justify-self-start !bg-cyan-300">Item 2</div>
                <div class="box-border">Item 3</div>
                <div class="box-border">Item 4</div>
                <div class="box-border">Item 5</div>
                <div class="box-border">Item 6</div>
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">'justify-self-center'는 그리드 항목의 인라인 축의 중앙 부분에 정렬합니다. 'justify-self-center-safe'는 화면이 작아지면 item이 컨테이너의 중앙 부분이 아닌 시작 부분을 맞춥니다.'</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
        ...
        <div class="tab-conts">
          <div role="tabpanel" aria-labelledby="tabList0101" id="tabPanel0101" class="tab-panel on">
            <div class="container normal">
              <div class="grid grid-cols-3 justify-items-stretch gap-2 p-3 bg-gray-200 w-full md:w-3xl">
                <div class="box-border">Item 1</div>
                <div class="box-border justify-self-center !bg-cyan-300">Item 2</div>
                <div class="box-border">Item 3</div>
                <div class="box-border">Item 4</div>
                <div class="box-border">Item 5</div>
                <div class="box-border">Item 6</div>
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">'justify-self-end'는 그리드 항목의 인라인 축의 끝 부분에 정렬합니다. 'justify-self-end-safe'는 화면이 작아지면 item이 컨테이너의 끝 부분이 아닌 시작 부분을 맞춥니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
        ...
        <div class="tab-conts">
          <div role="tabpanel" aria-labelledby="tabList0101" id="tabPanel0101" class="tab-panel on">
            <div class="container normal">
              <div class="grid grid-cols-3 justify-items-stretch gap-2 p-3 bg-gray-200 w-full md:w-3xl">
                <div class="box-border">Item 1</div>
                <div class="box-border justify-self-end !bg-cyan-300">Item 2</div>
                <div class="box-border">Item 3</div>
                <div class="box-border">Item 4</div>
                <div class="box-border">Item 5</div>
                <div class="box-border">Item 6</div>
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">'justify-self-stretch'는 그리드 항목의 인라인 축의 영역을 채웁니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
        ...
        <div class="tab-conts">
          <div role="tabpanel" aria-labelledby="tabList0101" id="tabPanel0101" class="tab-panel on">
            <div class="container normal">
              <div class="grid grid-cols-3 justify-items-start gap-2 p-3 bg-gray-200 w-full md:w-3xl">
                <div class="box-border">Item 1</div>
                <div class="box-border justify-self-stretch !bg-cyan-300">Item 2</div>
                <div class="box-border">Item 3</div>
                <div class="box-border">Item 4</div>
                <div class="box-border">Item 5</div>
                <div class="box-border">Item 6</div>
        ...
        <div class="tab-conts">
          <div role="tabpanel" aria-labelledby="tabList0101" id="tabPanel0101" class="tab-panel on">
            <div class="container normal">
              <div class="grid grid-cols-3 justify-items-stretch gap-2 p-3 bg-gray-200 w-full md:w-3xl">
                <div class="box-border">Item 1</div>
                <div class="box-border justify-self-start md:justify-self-end !bg-cyan-300">Item 2</div>
                <div class="box-border">Item 3</div>
                <div class="box-border">Item 4</div>
                <div class="box-border">Item 5</div>
                <div class="box-border">Item 6</div>
    ...
    <div class="conts-area">
      ...
      <div class="c-table-wrap c-scrollbar horizontal">
        <table class="c-table-type03">
          ...
          <tbody>
            <tr>
              <td data-header="class">justify-self-auto</td>
              <td data-header="style">justify-self: auto;</td>
            </tr>
            <tr>
              <td data-header="class">justify-self-start</td>
              <td data-header="style">justify-self: start;</td>
            </tr>
            <tr>
              <td data-header="class">justify-self-center</td>
              <td data-header="style">justify-self: center;</td>
            </tr>
            <tr>
              <td data-header="class">justify-self-center-safe</td>
              <td data-header="style">justify-self: safe center;</td>
            </tr>
            <tr>
              <td data-header="class">justify-self-end</td>
              <td data-header="style">justify-self: end;</td>
            </tr>
            <tr>
              <td data-header="class">justify-self-end-safe</td>
              <td data-header="style">justify-self: safe end;</td>
            </tr>
            <tr>
              <td data-header="class">justify-self-stretch</td>
              <td data-header="style">justify-self: stretch;</td>
            </tr>
          </tbody>
        </table>
      </div>
...
const value01 = ref(`<div class="grid grid-cols-3 justify-items-stretch gap-2">
  <div>Item 1</div>
  <div class="justify-self-auto">Item 2</div>
  <div>Item 3</div>
  <div>Item 4</div>
  <div>Item 5</div>
  <div>Item 6</div>
</div>`);
const value02 = ref(`<div class="grid justify-items-stretch grid-cols-3 gap-2">
  <div>Item 1</div>
  <div class="justify-self-start">Item 2</div>
  <div>Item 3</div>
  <div>Item 4</div>
  <div>Item 5</div>
  <div>Item 6</div>
</div>`);
const value03 = ref(`<div class="grid grid-cols-3 justify-items-stretch gap-2">
  <div>Item 1</div>
...
const value04 = ref(`<div class="grid grid-cols-3 justify-items-stretch gap-2">
  <div>Item 1</div>
...
const value05 = ref(`<div class="grid grid-cols-3 justify-items-start gap-2">
  <div>Item 1</div>
  <div class="justify-self-stretch">Item 2</div>
  <div>Item 3</div>
  <div>Item 4</div>
  <div>Item 5</div>
  <div>Item 6</div>
</div>`);
const value06 = ref(`<div class="grid grid-cols-3 justify-items-stretch gap-2">
  <div>Item 1</div>
  <div class="justify-self-start md:justify-self-end">Item 2</div>
  <div>Item 3</div>
  <div>Item 4</div>
  <div>Item 5</div>
  <div>Item 6</div>
