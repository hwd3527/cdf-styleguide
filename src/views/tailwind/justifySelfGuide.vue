<template>
  <div class="page-title-wrap gap-4 justify-between">
    <h2 class="cdf-h1">justify-self</h2>
    <a class="cdf-btn size-xs outline" href="https://tailwindcss.com/docs/justify-self" target="_blank">
  ...
  <div class="cont-zone-wrap">
    <div class="conts-area">
      ...
      <p class="cdf-information-text mt-5">'justify-self-auto'는 부모 'justify-items' 속성 값에 따라 정렬합니다.</p>
      <div class="tabs">
    ...
    <div class="conts-area">
      ...
      <p class="cdf-information-text mt-5">'justify-self-start'는 그리드 항목의 인라인 축의 시작 부분에 정렬합니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
    ...
    <div class="conts-area">
      ...
      <p class="cdf-information-text mt-5">'justify-self-center'는 그리드 항목의 인라인 축의 중앙 부분에 정렬합니다. 'justify-self-center-safe'는 화면이 작아지면 item이 컨테이너의 중앙 부분이 아닌 시작 부분을 맞춥니다.'</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
    ...
    <div class="conts-area">
      ...
      <p class="cdf-information-text mt-5">'justify-self-end'는 그리드 항목의 인라인 축의 끝 부분에 정렬합니다. 'justify-self-end-safe'는 화면이 작아지면 item이 컨테이너의 끝 부분이 아닌 시작 부분을 맞춥니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
    ...
    <div class="conts-area">
      ...
      <p class="cdf-information-text mt-5">'justify-self-stretch'는 그리드 항목의 인라인 축의 영역을 채웁니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
