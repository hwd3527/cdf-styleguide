<template>
  <div class="page-title-wrap gap-4 justify-between">
    <h2 class="c-h1">grid-template-columns</h2>
  ...
  <div class="cont-zone-wrap">
    <div class="conts-area">
      <h3 class="c-h3">grid 열 지정</h3>
      <p class="c-information-text mt-5">'grid-cols-&lt;number&gt;'를 사용하여 grid 컨테이너의 열 수를 지정합니다.</p>
      <div class="tabs">
    ...
    <div class="conts-area">
      <h3 class="c-h3">서브 그리드 구현</h3>
      <p class="c-information-text mt-5">'grid-cols-subgrid'를 사용하여 부모에 의해 정의될 열 트랙을 채택합니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">중단점으로 원하는 화면 크기에서 아이템의 그리드 수를 설정합니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
...
const value01 = ref(`<div class="grid grid-cols-4 gap-2">
  <div>Item 1</div>
  <div>Item 2</div>
  <div>Item 3</div>
  <div>Item 4</div>
...
const value02 = ref(`<div class="grid grid-cols-4 gap-2">
  <div>Item 1</div>
  <div>Item 2</div>
  <div>Item 3</div>
  <div>Item 4</div>
