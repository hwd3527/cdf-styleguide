<template>
  <div class="page-title-wrap gap-4 justify-between">
    <h2 class="cdf-h1">grid-template-columns</h2>
  ...
  <div class="cont-zone-wrap">
    <div class="conts-area">
      <h3 class="cdf-h3">grid 열 지정</h3>
      <p class="cdf-information-text mt-5">'grid-cols-&lt;number&gt;'를 사용하여 grid 컨테이너의 열 수를 지정합니다.</p>
      <div class="tabs">
        ...
        <div class="tab-conts">
          <div role="tabpanel" aria-labelledby="tabList0101" id="tabPanel0101" class="tab-panel on">
            <div class="container normal">
              <div class="grid grid-cols-4 gap-2 p-3 bg-gray-200 w-full md:w-3xl">
    ...
    <div class="conts-area">
      <h3 class="cdf-h3">서브 그리드 구현</h3>
      <p class="cdf-information-text mt-5">'grid-cols-subgrid'를 사용하여 부모에 의해 정의될 열 트랙을 채택합니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
            ...
            <div class="container normal">
              <div class="grid grid-cols-4 gap-2 p-3 bg-gray-200 w-full md:w-3xl">
                ...
                <div class="col-span-3 grid grid-cols-subgrid gap-2">
                  <div class="box-border col-start-2">Item 6</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="conts-area">
      ...
      <p class="cdf-information-text mt-5">중단점으로 원하는 화면 크기에서 아이템의 그리드 수를 설정합니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
        ...
        <div class="tab-conts">
          <div role="tabpanel" aria-labelledby="tabList0101" id="tabPanel0101" class="tab-panel on">
            <div class="container normal">
              <div class="grid grid-cols-1 md:grid-cols-6 gap-2 p-3 bg-gray-200 w-full md:w-3xl">
                <div class="box-border">Item 1</div>
                <div class="box-border">Item 2</div>
                <div class="box-border">Item 3</div>
                <div class="box-border">Item 4</div>
    ...
    <div class="conts-area">
      ...
      <div class="cdf-table-wrap cdf-scrollbar horizontal">
        <table class="cdf-table-type03">
          ...
          <tbody>
            <tr>
              <td data-header="class">grid-cols-&lt;number&gt;</td>
              <td data-header="style">grid-template-columns: repeat(&lt;number&gt;, minmax(0, 1fr));</td>
            </tr>
            <tr>
              <td data-header="class">grid-cols-none</td>
              <td data-header="style">grid-template-columns: none;</td>
            </tr>
            <tr>
              <td data-header="class">grid-cols-subgrid</td>
              <td data-header="style">grid-template-columns: subgrid;</td>
            </tr>
            <tr>
              <td data-header="class">grid-cols-[&lt;value&gt;]</td>
              <td data-header="style">grid-template-columns: &lt;value&gt;;</td>
            </tr>
            <tr>
              <td data-header="class">grid-cols-(&lt;custom-property&gt;)</td>
              <td data-header="style">grid-template-columns: var(&lt;custom-property&gt;);</td>
            </tr>
          </tbody>
        </table>
      </div>
...
const value01 = ref(`<div class="grid grid-cols-4 gap-2 p-3 bg-gray-100 w-full md:w-3xl">
  <div>Item 1</div>
  <div>Item 2</div>
  <div>Item 3</div>
  <div>Item 4</div>
...
const value02 = ref(`<div class="grid grid-cols-4 gap-2 p-3 bg-gray-100 w-full md:w-3xl">
  <div>Item 1</div>
  <div>Item 2</div>
  <div>Item 3</div>
  <div>Item 4</div>
  <div>Item 5</div>
  <div class="col-span-3 grid grid-cols-subgrid gap-2">
    <div class="col-start-2">Item 6</div>
  </div>
</div>`);
