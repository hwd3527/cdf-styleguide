<template>
  <div class="page-title-wrap gap-4 justify-between">
    <h2 class="c-h1">grid-row</h2>
    <a class="c-btn size-xs outline" href="https://tailwindcss.com/docs/grid-row" target="_blank">
      <span class="txt">tailwind에서 더보기</span>
    </a>
  </div>
  <div class="cont-zone-wrap">
    <div class="conts-area">
      <h3 class="c-h3">행 스패닝</h3>
      <p class="c-information-text mt-5">'row-span-&lt;number&gt;'를 사용하여 아이템을 n개의 행에 걸쳐 배치합니다.</p>
      <div class="tabs">
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">'row-start-&lt;number&gt;', 'row-end-&lt;number&gt;'를 사용하여 n번째 격자선에서 시작하거나
        끝나도록 할 수 있습니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
