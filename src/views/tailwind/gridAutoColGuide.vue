<template>
  <div class="page-title-wrap gap-4 justify-between">
    <h2 class="c-h1">grid-auto-columns</h2>
  ...
  <div class="cont-zone-wrap">
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">'auto-cols-max'를 사용하여 암묵적으로 생성되는 그리드 열의 최대 크기를 제어합니다.
      </p>
      <div class="tabs">
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">'auto-cols-min'를 사용하여 암묵적으로 생성되는 그리드 열의 최소 크기를 제어합니다.
      </p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
    ...
    <div class="conts-area">
      <h3 class="c-h3">auto-cols-auto</h3>
      <p class="c-information-text mt-5">'auto-cols-auto'를 사용하여 암묵적으로 생성되는 그리드 열의 자동 크기를 제어합니다.
      </p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
