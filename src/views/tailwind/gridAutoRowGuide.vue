        ...
        <div class="tab-conts">
          <div role="tabpanel" aria-labelledby="tabList0101" id="tabPanel0101" class="tab-panel on">
            <div class="container normal">
              <div class="grid auto-rows-max grid-flow-row gap-2 p-3 bg-gray-200 w-full md:w-3xl">
    ...
    <div class="conts-area">
      ...
      <div class="tabs">
        ...
        <div class="tab-conts">
          <div role="tabpanel" aria-labelledby="tabList0101" id="tabPanel0101" class="tab-panel on">
            <div class="container normal">
              <div class="grid auto-rows-min grid-flow-row gap-2 p-3 bg-gray-200 w-full md:w-3xl">
                <div class="box-border">Item 1</div>
                <div class="box-border">Item 2</div>
                <div class="box-border">Item 3</div>
              </div>
    ...
    <div class="conts-area">
      ...
      <div class="tabs">
        ...
        <div class="tab-conts">
          <div role="tabpanel" aria-labelledby="tabList0101" id="tabPanel0101" class="tab-panel on">
            <div class="container normal">
              <div class="grid auto-rows-auto grid-flow-row gap-2 p-3 bg-gray-200 w-full md:w-3xl">
                <div class="box-border">Item 1</div>
                <div class="box-border">Item 2</div>
                <div class="box-border">Item 3</div>
              </div>
    ...
    <div class="conts-area">
      ...
      <div class="tabs">
        ...
        <div class="tab-conts">
          <div role="tabpanel" aria-labelledby="tabList0101" id="tabPanel0101" class="tab-panel on">
            <div class="container normal">
              <div class="grid auto-rows-fr grid-flow-row gap-2 p-3 bg-gray-200 w-full md:w-3xl">
                <div class="box-border">Item 1</div>
                <div class="box-border">Item 2</div>
                <div class="box-border">Item 3</div>
              </div>
    ...
    <div class="conts-area">
      ...
      <div class="tabs">
        ...
        <div class="tab-conts">
          <div role="tabpanel" aria-labelledby="tabList0101" id="tabPanel0101" class="tab-panel on">
            <div class="container normal">
              <div class="grid auto-rows-max md:auto-rows-min grid-flow-row gap-2 p-3 bg-gray-200 w-full md:w-3xl">
                <div class="box-border">Item 1</div>
                <div class="box-border">Item 2</div>
                <div class="box-border">Item 3</div>
              </div>
    ...
    <div class="conts-area">
      ...
      <div class="cdf-table-wrap cdf-scrollbar horizontal">
        <table class="cdf-table-type03">
          ...
          <tbody>
            <tr>
              <td data-header="class">auto-rows-auto</td>
              <td data-header="style">grid-auto-rows: auto;</td>
            </tr>
            <tr>
              <td data-header="class">auto-rows-min</td>
              <td data-header="style">grid-auto-rows: min-content;</td>
            </tr>
            <tr>
              <td data-header="class">auto-rows-max</td>
              <td data-header="style">grid-auto-rows: max-content;</td>
            </tr>
            <tr>
              <td data-header="class">auto-rows-fr</td>
              <td data-header="style">grid-auto-rows: minmax(0, 1fr);</td>
            </tr>
            <tr>
              <td data-header="class">auto-rows-(&lt;custom-property&gt;)</td>
              <td data-header="style">grid-auto-rows: var(&lt;custom-property&gt;);</td>
            </tr>
            <tr>
              <td data-header="class">auto-rows-[&lt;value&gt;]</td>
              <td data-header="style">grid-auto-rows: &lt;value&gt;;</td>
            </tr>
          </tbody>
        </table>
      </div>
...
const value01 = ref(`<div class="grid auto-rows-max grid-flow-row gap-2">
  <div>Item 1</div>
  <div>Item 2</div>
  <div>Item 3</div>
</div>`);
const value02 = ref(`<div class="grid auto-rows-min grid-flow-row gap-2">
  <div>Item 1</div>
  <div>Item 2</div>
  <div>Item 3</div>
</div>`);
const value03 = ref(`<div class="grid auto-rows-auto grid-flow-row gap-2">
  <div>Item 1</div>
  <div>Item 2</div>
  <div>Item 3</div>
</div>`);
const value04 = ref(`<div class="grid auto-rows-fr grid-flow-row gap-2">
  <div>Item 1</div>
  <div>Item 2</div>
  <div>Item 3</div>
</div>`);
const value05 = ref(`<div class="grid auto-rows-max md:auto-rows-min grid-flow-row gap-2">
  <div>Item 1</div>
  <div>Item 2</div>
  <div>Item 3</div>
</div>`);
