<template>
  <div class="page-title-wrap gap-4 justify-between">
    <h2 class="c-h1">align-self</h2>
    <a class="c-btn size-xs outline" href="https://tailwindcss.com/docs/align-self" target="_blank">
  ...
  <div class="cont-zone-wrap">
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">'self-auto'는 컨테이너의 속성에 따라 아이템의 정렬을 자동으로 설정합니다.</p>
      <div class="tabs">
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">'self-start'는 컨테이너의 값과 관계없이 아이템을 시작 부분에 정렬합니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">'self-center'는 컨테이너의 값과 관계없이 아이템을 중앙 부분에 정렬합니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">'self-end'는 컨테이너의 값과 관계없이 아이템을 끝 부분에 정렬합니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">'self-baseline'는 항목의 기준선이 플렉스 컨테이너의 교차축 기준선과 일치하도록 정렬합니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">'self-baseline-last'는 컨테이너의 가로축을 따라 항목을 정렬하여 모든 항목의 마지막 기준선을 맞춥니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
