<template>
  ...
  <div class="cont-zone-wrap">
    <div class="conts-area">
      <h3 class="c-h3">정렬 순서를 설정</h3>
      <p class="c-information-text mt-5">'order-&lt;number&gt;'를 사용하여 문서에 나타나는 순서를 flex 및 grid 아이템의 정렬 순서를 설정합니다.</p>
      <div class="tabs">
    ...
    <div class="conts-area">
      <h3 class="c-h3">아이템을 처음 또는 마지막으로 정렬</h3>
      <p class="c-information-text mt-5">'order-first' 또는 'order-last'를 사용하여 flex 및 grid 아이템을 처음 또는 마지막으로 정렬합니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
    ...
    <div class="conts-area">
      ...
      <p class="c-information-text mt-5">중단점으로 원하는 화면 크기에서 아이템의 순서를 설정합니다.</p>
      <div class="tabs">
        <div role="tablist" class="tab-list">
          <a href="javascript:void(0)" role="tab" aria-controls="tabPanel0101" id="tabList0101" class="tab-list-item on"
            aria-selected="true" tabindex="0"><span>Preview</span></a>
