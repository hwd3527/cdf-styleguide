<template>
  ...
  <div class="cont-zone-wrap">
    ...
    <ComponentPreview 
      title="기본" 
      description="기본 selectbox , disabled, error 스타일 입니다." 
      :code="selectboxCode1" 
      bg="light"
    >
    ...
    <ComponentPreview 
      title="크기" 
      description="selectbox의 크기를 조절할 수 있습니다. size-xs, size-sm, size-md, size-lg, size-xl 5가지 사이즈가 있습니다." 
      :code="selectboxCode2"
      bg="light"
    >
      <div class="code-preview__conts__cluster w-full max-w-7xl">
    ...
    <ComponentPreview 
      title="가로형"
      description="가로형 selectbox 스타일 입니다."
      :code="selectboxCode3" bg="light">
      <div class="code-preview__conts__cluster w-full max-w-7xl">
...
const selectboxCode1 = `<div class="c-form">
  <div class="c-form__tit">
    <label for="select_name" class="c-form__label">레이블</label>
  </div>
  <div class="c-form__conts">
...
const selectboxCode2 = `<div class="c-form">
  <div class="c-form__tit">
    <label for="select_name" class="c-form__label">레이블</label>
  </div>
  <div class="c-form__conts">
...
const selectboxCode3 = `<div class="c-form c-form--horizontal">
  <div class="c-form__tit">
    <label for="input0401" class="c-form__label">레이블</label>
  </div>
  <div class="c-form__conts">
